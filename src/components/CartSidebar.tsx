...
import { X, ShoppingCart, Trash2, Calendar, MapPin, Scale, Package, CreditCard, DollarSign } from 'lucide-react';
        ...
        {items.length > 0 && (
          <div className="p-6 border-t border-gray-200 space-y-4">
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs text-green-600">
                      {items.filter(item => item.price).length} priced item{items.filter(item => item.price).length !== 1 ? 's' : ''}
                    </div>
                  </div>
                </div>
            ...
            >
              ...
              <span>Proceed to Checkout {totalPrice > 0 ? `(${totalPrice.toFixed(3)} ETH)` : ''}</span>
            </button>
